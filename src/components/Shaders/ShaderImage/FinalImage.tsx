...
import postVert from "@/components/Shaders/ShaderImage/post.vert";
import postFrag from "@/components/Shaders/ShaderImage/post.frag";
import { render, useFrame, useOGL } from "react-ogl";

export function FinalImage({ texture }: { texture: any }) {
